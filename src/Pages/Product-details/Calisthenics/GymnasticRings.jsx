...
import gymnasticRings from "../images/product-img/calisthenics-gymnastic-rings.jpeg"; // Import the image
import Navbar from "../../../Components/Navbar/Navbar";
import Footer from "../../../Components/Footer/Footer";

function GymnasticRings() {
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white text-black rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1 text-black">
            <h1 className="text-3xl font-semibold mb-4">Gymnastic Rings</h1>
            <p className="mb-4 text-yellow-500 text-2xl font-bold">₱1,000</p>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="list-disc pl-5" style={{ listStyleType: 'none' }}>
              <li><span className="text-gray-500 font-bold">Category</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Calisthenics</li> 
