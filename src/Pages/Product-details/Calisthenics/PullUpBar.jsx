...
import pullUpBar from "../images/product-img/calisthenics-pull-up-bar.jpeg"; // Import the image
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white text-black rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1 text-black">
            <h1 className="text-3xl font-semibold mb-4">Pull Up Bar</h1>
            <p className="mb-4 text-yellow-500 text-2xl font-bold">₱1,600</p>
