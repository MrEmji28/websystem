...
import benchrack from "../images/product-img/freeweights-benchrack.jpeg"; // Import the image
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white text-black rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1 text-black">
            <h1 className="text-3xl font-semibold mb-4">Weight Bench</h1>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="list-disc pl-5" style={{ listStyleType: 'none' }}>
              <li><span className="text-gray-500 font-bold">Category</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Free Weights</li> 
