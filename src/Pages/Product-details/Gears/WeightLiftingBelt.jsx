...
import weightLiftingBelt from "../images/product-img/gears-weight-lifting-belt.jpeg"; // Import the image
import Navbar from "../../../Components/Navbar/Navbar";
import Footer from "../../../Components/Footer/Footer";

function WeightLiftingBelt () {
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white text-black rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1 text-black">
            <h1 className="text-3xl font-semibold mb-4">Weight Lifting Belt</h1>
            <p className="mb-4 text-yellow-500 text-2xl font-bold">₱600</p>
...
export default WeightLiftingBelt;
