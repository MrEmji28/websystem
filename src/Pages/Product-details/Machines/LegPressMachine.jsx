...
import legPressMachine from "../images/product-img/machines-leg-press-machine.jpeg"; // Import the image
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white text-black rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1 text-black">
            <h1 className="text-3xl font-semibold mb-4">Leg Press Machine</h1>
...
export default LegPressMachine;
