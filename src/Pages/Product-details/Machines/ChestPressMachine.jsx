...
import chestPressMachine from "../images/product-img/machines-chest-press-machine.jpeg"; // Import the image
import Navbar from "../../../Components/Navbar/Navbar";
import Footer from "../../../Components/Footer/Footer";

function ChestPressMachine() {
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white text-black rounded-lg shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-1 text-black">
            <h1 className="text-3xl font-semibold mb-4">Chest Press Machine</h1>
...
export default ChestPressMachine;
